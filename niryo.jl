...
# ╔═╡ 1b5a4355-a1cc-4222-8ecc-2611b8d90bb1
let
        if (TOC)
...
# ╔═╡ 4e167f23-1943-4215-b091-c5ebeb8b1def
HTML("""
...
# ╔═╡ ca0e4303-f264-40b5-8441-fcb388fa4b6b
md"""
# Depth Processing
"""

# ╔═╡ f7693e1a-1c51-449a-8cd4-b7b781a8bfb5
HTML("""<center><video src = "https://raw.githubusercontent.com/cfarm6/BondGraphPictures/main/videos/depth.mp4" type="video/mp4" loop autoplay muted width = 700></video></center>""")
...
HTML("""<center><video src = "https://raw.githubusercontent.com/cfarm6/BondGraphPictures/main/videos/edge.mp4" type="video/mp4" loop autoplay muted width = 700></video></center>""")

# ╔═╡ 3d836195-3408-40e7-a469-7828722d8d9b
# HTML("""<center><img src="https://raw.githubusercontent.com/cfarm6/BondGraphPictures/main/animations/fac570.gif" width=900px></center>""")
# HTML("""<center><img src="https://raw.githubusercontent.com/cfarm6/BondGraphPictures/main/animations/moving_boxes.gif" width=200px></center>""")
# HTML("""<center><img src="https://raw.githubusercontent.com/cfarm6/BondGraphPictures/main/animations/robot_arm.gif" width=200px></center>""")
# HTML("""<center><img src="https://raw.githubusercontent.com/cfarm6/BondGraphPictures/main/animations/scanning_belt.gif" width=500px></center>""")
# HTML("""<center><img src="https://raw.githubusercontent.com/cfarm6/BondGraphPictures/main/animations/moving_belt.gif" width=500px></center>""")
...
md"""
# Formatting, Settings, and Imports
"""

# ╔═╡ 30e00650-3199-41c7-8953-70e5b88f5860
html"""
<style>
pluto-output h1 {border-bottom: 4px solid  hsla(25, 100%, 38%, 1.0)}
pluto-output h2 {border-bottom: 3px dotted hsla(25, 100%, 38%, 1.0)}
pluto-output h3 {border-bottom: 2px dotted hsla(25, 100%, 38%, 1.0)}
...
[[deps.MeshCat]]
deps = ["Base64", "BinDeps", "Blink", "Cassette", "Colors", "CoordinateTransformations", "DocStringExtensions", "FFMPEG", "GeometryBasics", "LinearAlgebra", "Logging", "MsgPack", "Mux", "Parameters", "Pkg", "Requires", "Rotations", "Sockets", "StaticArrays", "UUIDs", "WebSockets"]
git-tree-sha1 = "bd707ee5273b7778554b0b22b3071cf97f71e1f4"
