...
# ╔═╡ a02ebcd8-2408-45bf-bb93-131ae33b6e93
begin
	using MeshCat
...
# ╔═╡ b6224739-0c94-480c-94b5-bd8b0d4192b6
begin
...
md"""
# Sim-to-Real Approaches for Remote Learning and experimental testing
"""
...
mvis = let
	...
	filename = "/niryo_one_description/urdf/v1/niryo_one.urdf"
	contents = read(location*filename, String)
	contents = replace(contents, "PATH"=>location)
	temp = mktempdir()
	write(joinpath(temp, "niryo_one.urdf"), contents)
	joinpath(temp, "niryo_one.urdf")
	robot = parse_urdf(joinpath(temp, "niryo_one.urdf"))
	vis = Visualizer();
	delete!(vis)	
	mvis = MechanismVisualizer(robot, URDFVisuals(joinpath(temp, "niryo_one.urdf")), vis)
end;

# ╔═╡ 5d96ceb2-fc9a-40c5-a592-3b133834cbea
render_static(mvis.visualizer)

# ╔═╡ dd6a5af2-61fb-4e3e-b395-0719c0435044
md"""
# Computer Vision and Stereoscopic Imaging for Manufacturing Line Processing
"""

# ╔═╡ 81879fad-d697-403a-a446-733f1742b46c
md"""
## Depth Processing
"""

# ╔═╡ c8680a79-3fae-43eb-8e3c-de051a583e24
...
# ╔═╡ f4599201-8325-4fa2-beca-91dcdcb5a5b4
md"""
## Edge Detection
"""

# ╔═╡ dfa78061-99d5-45e0-b904-323d6106b35b
...
md"""
# Interactive System Dynamics for learning Process Simulation
"""

# ╔═╡ 4cdfff96-e496-44dc-a4e0-a53e317f584d
...
# md"""
# # Machine Learning for Process Improvement and Defect Detection
# # """

# ╔═╡ 85d201ec-de70-48c9-b5a1-ca920f79d05a
begin
...
# ╔═╡ b2a62b13-60b1-4fe4-a1c8-32973af8c8e6
...
let
	...
	AR_plt = plot(ωs./2π, AR, xscale = :log10, title = "Amplitude Ratio", xlabel = "Frequency [Hz]", ylabel = "Amplitude [db]")
	plot(disp_plt, AR_plt)
end
